    ...
    <>
      ...
      <ScrollView style={styles.column}>
        ...
        <Text style={styles.firstSentence}>
          Enter MediaNet account number, owner's ID number and select a package
          to pay bill.
        </Text>
        ...
        <View style={{paddingHorizontal: 20, paddingTop: 10}}>
          <Text style={{color: 'red'}}>
            Medianet payments are NOT available for Vilimale', Hulhumale' phase
            2 and multiscreen users.
          </Text>
          <View
            style={{
              width: 100,
