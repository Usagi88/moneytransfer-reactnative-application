  ...
  return (
    <ScrollView style={styles.column}>
      <Text style={styles.firstSentence}>
        Enter the Dhiraagu Business Reload number and amount to send reload.
      </Text>
      ...
      <View style={styles.buttonWrapper}>
        <TouchableNativeFeedback onPress={() => {}} useForeground={true}>
          <LinearGradient
            ...
            style={styles.button}>
            <Text style={styles.buttonText}>Send Reload</Text>
          </LinearGradient>
        </TouchableNativeFeedback>
      </View>
    </ScrollView>
...
export default DhiraaguWholesale;
